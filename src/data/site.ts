...
export const nav: NavItem[] = [
  { path: '/', label: 'Home', title: 'Genova Mongalo — AI Engineer',
    description: 'AI/ML engineer focused on generative models, transformers, and cybersecurity applications.' },
  ...
  { path: '/skills', label: 'Skills', title: 'Skills — Genova Mongalo',
    description: 'Languages, frameworks, libraries, and specialized AI/ML and security skills.' },
